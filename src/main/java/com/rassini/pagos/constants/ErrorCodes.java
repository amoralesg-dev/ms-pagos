...
public final class ErrorCodes {
    ...
    public static final String ERR033 = "ERR033";
    public static final String ERR034 = "ERR034";
    public static final String ERR035 = "ERR035";
    public static final String ERR036 = "ERR036";
    public static final String ERR037 = "ERR037";
    public static final String ERR038 = "ERR038";
    public static final String ERR039 = "ERR039";
    public static final String ERR040 = "ERR040";
    public static final String ERR041 = "ERR041";
    public static final String ERR042 = "ERR042";
    public static final String ERR043 = "ERR043";

    // Duplicados
    public static final String ERR044 = "ERR044";
